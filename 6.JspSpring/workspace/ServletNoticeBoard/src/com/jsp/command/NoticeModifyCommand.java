...
public class NoticeModifyCommand {
	...
	public NoticeVO toNoticeVO() {
		...
		String lineContent = content.replace("\n", "<br>").replace("\n", "<br>");
		noticeVO.setContent(lineContent);
		int integerNNo = Integer.parseInt(nNo);
		noticeVO.setnNo(integerNNo);
		int integerPoint = Integer.parseInt(point);
		noticeVO.setPoint(integerPoint);
