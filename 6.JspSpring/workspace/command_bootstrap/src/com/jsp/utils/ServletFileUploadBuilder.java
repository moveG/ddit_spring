...
public class ServletFileUploadBuilder {
	...
	public static ServletFileUpload build(int MEMORY_THRESHOLD, int MAX_FILE_SIZE, int MAX_REQUEST_SIZE) {
		//업로드를 위한 upload 환경설정 적용, FileItem오브젝트 생성
	...
	public static ServletFileUpload build(HttpServletRequest request, int MEMORY_THRESHOLD, int MAX_FILE_SIZE, int MAX_REQUEST_SIZE) 
