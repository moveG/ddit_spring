		...
		<div class="card" style="min-width:450px;">	
			<div class="card-body">	
				<div class="row">					
					...
					<input type="file" id="inputFile" name="picture" onchange="changePicture_go();" style="display:none" />
					<div class="input-group col-md-12">
						<div class="col-md-12" style="text-align: center;">
							...
							<div class="input-group input-group-sm">
								...
								<input type="text" id="inputFileName" name="tempPicture" class="form-control" value="" readonly>
								<input type="hidden" id="picture" name="uploadPicture" class="form-control">
							</div>						
						</div>												
					</div>
				</div>	
