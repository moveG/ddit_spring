    ...
    <section class="content">		
		<div class="card">
			<div class="card-header with-border">
				<button type="button" class="btn btn-primary" id="registBtn" onclick="OpenWindow('registForm.do','공지등록',800,850);">공지등록</button>				
...
<%-- 	window.onload=function(){
    	$("[data-target='notice-writer']").click(function(event){    		
    		OpenWindow('<%=request.getContextPath()%>/notice/detail.do?id='
