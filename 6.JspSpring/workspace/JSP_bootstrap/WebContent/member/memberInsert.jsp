	...
	$(function(){
		...
		$('#pwd').on('keyup', function(){
			...
			if(pwdreg.test(pwdvalue) == true){
				...
				$(this).css('border', '2px solid red');
				$('#pwdspan').html("대문자, 소문자, 숫자, 특수문자를 조합하여, 8 ~ 20자까지 가능합니다.").css('color', 'red');
...
<div class="content-wrapper">
	...
	<div class="content-header">
		<div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-6">
					<h1 class="m-0" style="cursor:pointer;" onclick="location.href='MemberInsert.do'">MemberInsert</h1>
				</div><!-- /.col -->
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right">
						<li class="breadcrumb-item"><a href="#">Home</a></li>
						<li class="breadcrumb-item active">MemberInsert</li>
					</ol>
				</div><!-- /.col -->
			</div><!-- /.row -->
		</div><!-- /.container-fluid -->
	...
	<div class="content">
		<div class="container-fluid">
			<div class="row">
				...
				<div class="col-lg-8 col-6 container">
					<div class="card">
						<!-- form start -->
