		...
		<div class="container-fluid">
			<div class="card">
				<div class="card-header with-border">
					<div class="row">
						<div class="col-md-5">
							<button type="button" class="btn btn-sm btn-primary" onclick="OpenWindow('registForm.do', 'NoticeRegist', 822, 1000);">등록</button>
						</div>
						<div class="col-md-7">
							...
							<table class="table table-sm table-hover" style="table-layout:fixed;margin-bottom:0px;">
								...
								<tbody>
									...
									<c:if test="${!empty pointList}">
										...
										<tr style="cursor:pointer;" onclick="OpenWindow('detail.do?nno=${point.nno}&from=list', 'NoticeDetail', 900, 1000);">
									...
									<c:if test="${!empty noticeList}">
										...
										<tr style="cursor:pointer;border-bottom:1px solid #dee2e6;" onclick="OpenWindow('detail.do?nno=${notice.nno}', 'NoticeDetail', 900, 1000);">
											<td>${notice.nno}</td>
											<td>
												<div style="overflow:hidden;white-space:nowrap;text-overflow:ellipsis;text-align:left;">
													${notice.title}
