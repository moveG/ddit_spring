					...
					<div class="row">
						<div class="col-md-12">
							<div class="form-group input-group">
								<input type="text" class="form-control" placeholder="Enter Reply" id="newreplyText" style="display:inline-block;" onKeypress="javascript:if(event.keyCode==13) {replyRegist_go();}">
