...
<div class="replyLi">
	<div class="user-block">
		<img src="<%=request.getContextPath()%>/member/getPictureById.do/{{replyer}}" class="img-circle"/>
    </div>
...
window.onload = function(){
	getPage("<%=request.getContextPath()%>/replies/${boardVO.bno}/" + replyPage);
...
function replyRemove_go(){
	...
	$.ajax({
		url : "<%=request.getContextPath()%>/replies/${boardVO.bno}/" + rno + "/" + replyPage,
		type : "delete",
		headers : {"X-HTTP-Method-Override" : "DELETE"},
		success : function(page){
			alert("삭제되었습니다.");
			getPage("<%=request.getContextPath()%>/replies/${boardVO.bno}/" + page);
			replyPage = page;
		},
		error : function(error){
			//alert("삭제 실패했습니다.");
