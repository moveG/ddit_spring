...
<body class="hold-transition sidebar-mini layout-boxed" style="background:#343a40">
	<div class="wrapper">
		<!-- Navbar -->
		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			...
			<a href="index3.html" class="brand-link">
				<img src="<%=request.getContextPath()%>/resources/bootstrap/dist/img/PMSProjectLogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
				<span class="brand-text font-weight-light">Project Oceans</span>
			</a>
		...
		<footer class="main-footer">
			...
			<strong>Copyright &copy; 2022 <a href="https://www.project-oceans.com">Project-Oceans.com</a>.</strong> All rights reserved.
		</footer>
	</div>
	<!-- ./wrapper -->
