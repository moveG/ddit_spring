    ...
    <div class="sidebar">
      ...
      <c:if test="${!empty loginUser}">
	      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
	        ...
	        <div class="info">
	          <div class="row">
		          <a href="javascript:OpenWindow('<%=request.getContextPath()%>/member/detail.do?id=${loginUser.id}', '내 정보', '800', '900');" class="d-block">${loginUser.name}</a>
		          &nbsp;&nbsp;
		          <button type="button" class="btn btn-xs btn-primary col-xs-3" onclick="location.href='<%=request.getContextPath()%>/common/logout.do';">LOGOUT</button>
	          </div>
