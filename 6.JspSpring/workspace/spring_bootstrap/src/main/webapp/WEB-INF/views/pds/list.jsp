    ...
    <section class="content">
		<div class="card">
			<div class="card-header with-border">
				<button type="button" class="btn btn-primary" id="registBtn" onclick="OpenWindow('registForm.do','상세보기',800,900);">자료등록</button>
					...
					<c:forEach items="${pdsList }" var="pds">
						<tr style='font-size:0.85em;'>
							...
							<td id="boardTitle" style="text-align:left;max-width: 100px; overflow: hidden;
								...
								<a href="javascript:OpenWindow('detail.do?pno=${pds.pno}&from=list','상세보기',800,900);">
