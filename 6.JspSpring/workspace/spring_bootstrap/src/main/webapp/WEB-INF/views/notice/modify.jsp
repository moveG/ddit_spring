					...
					<div class="card-body">
						<form role="form" method="post" action="modify.do" name="modifyForm">
							...
							<div class="form-group">
								...
								<input type="text" id="writer" name="writer" class="form-control" value="${notice.writer}" readonly>
							</div>
							<div class="form-group">
								<label for="content">내 용</label>		
								<textarea id="content" name="content" class="form-control" rows="3" placeholder="500자 내외로 작성하세요.">
